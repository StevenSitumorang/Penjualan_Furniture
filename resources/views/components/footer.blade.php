<footer class="bg-black dark:bg-gray-900 w-full">
    <div class="mx-auto max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="http://127.0.0.1:8000/dashboard" class="flex items-center space-x-2 rtl:space-x-reverse">
                    <img src="/image/logo.jpg" class="h-12 w-12" alt="Furniture Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap text-white dark:text-white">FurniCorp</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-white font-medium">
                        ...
                        <li>
                            <a href="#" class="hover:underline text-white">Product</a><br>
                        </li>
                        <li class="mb-4">
                        <li>
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Customer Servis</h2>
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="#" class="hover:underline text-white">Contact</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline text-white">Sitemap</a><br>
                        </li>
                        <li class="mb-4">
                        <li>
                            <a href="#" class="hover:underline text-white">FAQS</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline text-white">FurniCorp™</a>. All Rights Reserved.</span>
