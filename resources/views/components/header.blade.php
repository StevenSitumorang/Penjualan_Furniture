<!-- Header -->
<header class="header fixed top-0 w-full bg-black dark:bg-gray-900 z-50">
    <nav class="bg-black dark:bg-gray-900 fixed w-full overflow-hidden">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6">
            <a href="http://127.0.0.1:8000/dashboard" class="flex items-center space-x-2 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-white">FurniCorp</span>
            </a>
            ...
            <div class="hidden w-full lg:flex lg:w-auto" id="navbar-default">
                <ul class="flex flex-col mt-4 space-y-2 lg:flex-row lg:space-x-8 lg:mt-0 lg:space-y-0">
                    <li>
                        <a href="/dashboard" class="nav-link text-lg text-white hover:bg-gray-100 dark:hover:bg-gray-600 px-3 py-2 rounded">Home</a>
                    </li>
                    <li>
                        <a href="/about" class="nav-link text-lg text-white hover:bg-gray-100 dark:hover:bg-gray-600 px-3 py-2 rounded">About</a>
                    </li>
                    <li>
                        <a href="/produk_furniture" class="nav-link text-lg text-white hover:bg-gray-100 dark:hover:bg-gray-600 px-3 py-2 rounded">Product</a>
                    </li>
                    <li>
                        <a href="/kontak" class="nav-link text-lg text-white hover:bg-gray-100 dark:hover:bg-gray-600 px-3 py-2 rounded">Contact</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <button class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false" onclick="toggleDropdown('navbar-default')">
                ...
                <div class="relative z-50">
                    <div class="absolute right-0 mt-2 w-40 bg-white divide-y divide-gray-50 dark:divide-gray-50 hidden z-50 " id="account-dropdown" aria-labelledby="menu-button">
