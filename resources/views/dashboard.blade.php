...
<!-- Banner -->
<div class="bg-gray-200 dark:bg-gray-700 px-5 py-25 lg:py-32 w-screen overflow-hidden">
    <div class="grid max-w-screen-xl px-4 mx-auto lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <a href="/produk_furniture" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white border border-gray-300 rounded-lg hover:bg-gray-700 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800 bg-gray-800 mt-4">Shop Now</a>
        </div>
...
<!-- Kenapa Memilih Kami -->
<div class="bg-beige dark:bg-gray-900 px-5 py-8 lg:py-16 w-full overflow-hidden"> <!-- Menambahkan w-full agar mengisi lebar layar -->
...
<div class="bg-beige dark:bg-gray-900 px-5 py-8 lg:py-16 w-full overflow-hidden"> <!-- Menambahkan w-full agar mengisi lebar layar -->
    ...
    <div class="bg-beige dark:bg-gray-900 px-5 py-8 lg:py-16 w-full overflow-hidden  top-0 z-50">
...
<!-- Testimonial -->
<div class="bg-beige dark:bg-gray-900 px-5 py-8 lg:py-16 w-full overflow-hidden top-0 z-50"> <!-- Menambahkan w-full agar mengisi lebar layar -->
    <div class="px-4 mx-auto max-w-screen-xl">
