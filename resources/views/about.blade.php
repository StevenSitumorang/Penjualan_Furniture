...
<section class="bg-white py-16">
 ...
 <div class="relative w-full h-64 sm:h-72 md:h-96 lg:h-80 xl:h-96">
    ...
    <div class="mx-auto max-w-screen-sm text-center">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-gray-900">Discover Our Latest Furniture Collection</h2>
        <p class="mb-6 font-light text-gray-500 md:text-lg">Explore our premium furniture collection and elevate your living space. From comfortable sofas to elegant dining sets, find the perfect pieces to suit your style.</p>
        <a href="/produk_furniture" class="text-white bg-gray-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Explore Now</a>
    </div>
</div>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    <div class="max-w-screen-md mb-8 lg:mb-16">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Elevate Your Space with Our Furniture Solutions</h2>
      <p class="text-gray-500 sm:text-xl">At FurniCorp, we're dedicated to providing innovative furniture solutions that enhance your living or working environment. Discover our range of high-quality furniture crafted to elevate every room.</p>
    </div>
